...
import { BookmarkIcon, HeartIcon, LockClosedIcon, PowerIcon, UserCircleIcon, WalletIcon } from "@heroicons/react/24/outline";
...
const Layout: React.FC<LayoutProps> = ({ children }) => {
  ...
  return (
    <div className="flex h-screen overflow-hidden">
      {/* Sidebar */}
      <aside
        className={`fixed bg-gray-200 text-white w-64 p-4 h-full transition-transform ${
          isSidebarOpen ? 'translate-x-0 z-999' : '-translate-x-64 pt-20'
        } sm:translate-x-0`}
      >
        {isSidebarOpen?<button className='ml-50 text-black'  onClick={toggleSidebar}><i className="fa-solid fa-arrow-left"></i></button>:""}
        <nav>
        <List
              ...
              >
                ...
                <Link to={USER.PROFILE}>
                  <ListItem
                    className={`${path.pathname == USER.PROFILE ? "bg-gray-400" : ""}`}
                    placeholder={undefined}
                    onPointerEnterCapture={undefined}
                    onPointerLeaveCapture={undefined}
                  >
                ...
                <Link to={`${USER.PROFILE}${USER.CHANGE_PWD}`}>
                  <ListItem
                    className={`${path.pathname == `${USER.PROFILE}${USER.CHANGE_PWD}` ? "bg-gray-400" : ""}`}
                    placeholder={undefined}
                    onPointerEnterCapture={undefined}
                    onPointerLeaveCapture={undefined}
                  >
                ...
                <Link to={`${USER.PROFILE}${USER.FAV}`}>
                  <ListItem
                    className={`${path.pathname == `${USER.PROFILE}${USER.FAV}` ? "bg-gray-400" : ""}`}
                    placeholder={undefined}
                    onPointerEnterCapture={undefined}
                    onPointerLeaveCapture={undefined}
                  >
                ...
                <Link to={`${USER.PROFILE}${USER.WALLET}`}>
                  <ListItem
                    className={`${path.pathname == `${USER.PROFILE}${USER.WALLET}` ? "bg-gray-400" : ""}`}
                    placeholder={undefined}
                    onPointerEnterCapture={undefined}
                    onPointerLeaveCapture={undefined}
                  >
                ...
                <Link to={`${USER.PROFILE}${USER.INBOX}`}>
                  <ListItem
                    className={`${path.pathname == `${USER.PROFILE}${USER.INBOX}` ? "bg-gray-400" : ""}`}
                    placeholder={undefined}
                    onPointerEnterCapture={undefined}
                    onPointerLeaveCapture={undefined}
                  >
