...
const UserNavbar=()=> {
  ...
  return (
    <Navbar className="px-4  lg:px-8 lg:py-2 lg:mb-6 bg-dark" placeholder={undefined} style={{borderRadius: 0, border: 0,backgroundColor: "rgba(18, 19, 20, 0.7)"}}  onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined} >
