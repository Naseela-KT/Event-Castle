...
const ProfileCard = () => {
  ...
  return (
    <Card className="w-96 mx-auto"  placeholder={undefined} onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined}>
    <form onSubmit={handleSubmit}>
      <CardHeader className="h-50 bg-transparent shadow-none flex items-center justify-center"  placeholder={undefined} onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined}>
        {previewUrl ? (
          <img
            src={previewUrl}
      ...
      <CardBody className="text-center flex flex-col gap-4"  placeholder={undefined} onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined}>
        {user?.email && (
          <Input
              label="Email"
              disabled
              size="md"
              value={user.email}
              onChange={() => { } } onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined} crossOrigin={undefined}          />
        )}
        <Input
            label="Name"
            size="md"
