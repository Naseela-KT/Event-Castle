...
const About = () => {
  ...
  return (
    <>
      <div className="relative flex h-screen content-center items-center justify-start lg:pt-16 pt-6 pb-20 mb-0">
        ...
        <Card
          className="mt-4 lg:ml-20 ml-10 lg:justify-start bg-transapent"
  ...
  <div className="grid grid-cols-4 gap-4 md:grid-cols-4">
    ...
    <div className="grid gap-4">
      <div className="overflow-hidden group">
        <img
          className="h-auto max-w-full rounded-lg object-cover object-center transform transition-transform duration-300 group-hover:scale-110"
          src="/imgs/about/ev-4.jpg"alt="gallery-photo"
        />
      </div>
      <div className="overflow-hidden group">
        <img
          className="h-auto max-w-full rounded-lg object-cover object-center transform transition-transform duration-300 group-hover:scale-110"
          src="/imgs/about/ev-5.jpg" alt="gallery-photo"
        />
      </div>
      <div className="overflow-hidden group">
        <img
          className="h-auto max-w-full rounded-lg object-cover object-center transform transition-transform duration-300 group-hover:scale-110"
          src="/imgs/about/ev-6.jpg" alt="gallery-photo"
        />
      </div>
    </div>
    <div className="grid gap-4">
      <div className="overflow-hidden group">
        <img
          className="h-auto max-w-full rounded-lg object-cover object-center transform transition-transform duration-300 group-hover:scale-110"
          src="/imgs/about/ev-7.jpg" alt="gallery-photo"
        />
      </div>
      <div className="overflow-hidden group">
        <img
          className="h-auto max-w-full rounded-lg object-cover object-center transform transition-transform duration-300 group-hover:scale-110"
          src="/imgs/about/ev-8.jpg" alt="gallery-photo"
        />
      </div>
      <div className="overflow-hidden group">
        <img
          className="h-auto max-w-full rounded-lg object-cover object-center transform transition-transform duration-300 group-hover:scale-110"
          src="/imgs/about/ev-9.jpg" alt="gallery-photo"
        />
      </div>
    </div>
    <div className="grid gap-4">
      <div className="overflow-hidden group">
        <img
          className="h-auto max-w-full rounded-lg object-cover object-center transform transition-transform duration-300 group-hover:scale-110"
          src="/imgs/about/ev-10.jpg" alt="gallery-photo"
        />
      </div>
      <div className="overflow-hidden group">
        <img
          className="h-auto max-w-full rounded-lg object-cover object-center transform transition-transform duration-300 group-hover:scale-110"
          src="/imgs/about/ev-11.jpg" alt="gallery-photo"
        />
      </div>
      <div className="overflow-hidden group">
        <img
          className="h-auto max-w-full rounded-lg object-cover object-center transform transition-transform duration-300 group-hover:scale-110"
          src="/imgs/about/ev-12.jpg" alt="gallery-photo"
        />
      </div>
    </div>
  </div>
      ...
      <section className="lg:my-20 -mt-20">
        <div className="lg:text-center lg:mb-8 mb-4 ml-20">
          <h2 className="text-2xl font-bold"  style={{ fontFamily: "playfair display", fontSize: "30px" }}>Process</h2>
        </div>
  ...
  <div className="w-full md:w-1/2 lg:w-1/4 p-4 cursor-pointer">
    <div className="rounded-lg shadow-md p-6 flex items-center bg-[#fce9f1] transform transition-transform duration-300 hover:scale-105">
      ...
      <div>
        <h3 className="text-lg font-semibold text-gray-800 mb-2">Find</h3>
        <p className="text-gray-600">Find vendors for your event needs</p>
      </div>
    </div>
  </div>
  <div className="w-full md:w-1/2 lg:w-1/4 p-4 cursor-pointer">
    <div className="bg-[#fce9f1] rounded-lg shadow-md p-6 flex items-center transform transition-transform duration-300 hover:scale-105">
      ...
      <div>
        ...
        <p className="text-gray-600">Contact vendors through the platform</p>
      </div>
    </div>
  </div>
  <div className="w-full md:w-1/2 lg:w-1/4 p-4 cursor-pointer">
    <div className="bg-[#fce9f1] rounded-lg shadow-md p-6 flex items-center transform transition-transform duration-300 hover:scale-105">
      ...
      <div>
        <h3 className="text-lg font-semibold text-gray-800 mb-2">Plan</h3>
        ...
        <div className="relative h-100 w-full bg-[url('imgs/about/ready-img.jpg')] bg-cover bg-center">
          ...
          <div className="relative flex items-center justify-end h-full w-full p-8">
            <div className="bg-white bg-opacity-70 p-8 rounded-lg max-w-lg">
              <h2 className="lg:text-3xl text-xl font-bold mb-4"  style={{ fontFamily: "playfair display", fontSize: "30px" }}>Are you ready?</h2>
              <Typography
